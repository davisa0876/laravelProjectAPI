...
<script>
    window.onload = function () {
        ...
        @php
            ...
            $hasOauth2 = !empty($securitySchemes) && in_array('oauth2', array_column($securitySchemes, 'type'));
        @endphp

        @if($hasOauth2)
        ui.initOAuth({
            usePkceWithAuthorizationCodeGrant: "{{ config('l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant', false) }}"
        })
        @endif
    }
</script>
